  ...
  return (
    <main className="min-h-screen bg-white w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 w-full pt-8 pb-16">
        ...
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Do You Need to File Self Assessment?</h2>
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            <div>
              <h3 className="text-gray-900 font-semibold mb-4 text-lg">You MUST file if:</h3>
              <ul className="space-y-3 text-gray-700 text-sm">
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✓</span> Self-employed (turnover &gt; £1,000)
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✓</span> Taxable income &gt; £100,000
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✓</span> Rental income (£1,000+)
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✓</span> Dividend income &gt; £1,000
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✓</span> Untaxed interest (after £1k allowance)
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✓</span> Trustees or beneficiaries
                </li>
              </ul>
            </div>
            <div>
              <h3 className="text-gray-900 font-semibold mb-4 text-lg">You DON'T need to file if:</h3>
              <ul className="space-y-3 text-gray-700 text-sm">
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✗</span> Employee earning &lt; £100k
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✗</span> Tax paid via PAYE entirely
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✗</span> All income in ISAs
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✗</span> No trading income
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✗</span> HMRC hasn't sent notice
                </li>
                <li className="flex gap-3">
                  <span className="text-gray-900 font-bold">✗</span> Only receive employment income
                </li>
              </ul>
            </div>
          </div>
          <div className="text-gray-700 text-sm p-4 bg-slate-50 rounded-lg border border-gray-200">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Important Deadlines</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              <h3 className="text-gray-900 font-bold mb-2 text-lg">5 April</h3>
              <p className="text-gray-700 text-sm mb-3">End of UK tax year</p>
              <p className="text-gray-600 text-xs">New tax year begins 6 April. Last day to make contributions to previous year's pension.</p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              <h3 className="text-gray-900 font-bold mb-2 text-lg">31 October</h3>
              <p className="text-gray-700 text-sm mb-3">Paper return deadline</p>
              <p className="text-gray-600 text-xs">Last day to submit paper Self Assessment return (6 months after tax year end)</p>
            </div>
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
              <h3 className="text-gray-900 font-bold mb-2 text-lg">31 January</h3>
              <p className="text-gray-700 text-sm mb-3">Online deadline & tax due</p>
